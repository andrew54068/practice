...
class RocheCategoryCollectionView2: UICollectionView, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    
    private let cellId = "RCVCell2"
...
//        fatalError("init(coder:) has not been implemented")
    ...
    func setUpView(){
        ...
        let nib = UINib(nibName: "RocheCollectionViewCell2", bundle: nil)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! RocheCollectionViewCell2
